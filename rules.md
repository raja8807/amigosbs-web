...
- **Primary Color Alternatives**: `#a91a1f`, `#e9021e` (Dark Red aesthetic)
- **Background Tones**: `$color_b1: #0b0b0b`, `$color_b2: #121212`, `$color_b3: #222222`
- **Text Tones**: `$color_text_grey: #ffffffa6`, `$color_text_grey2: #cecece`
- **General Body**: Features a warm background color (`#fff8f3`).
