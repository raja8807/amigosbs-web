      ...
      <CustomContainer>
        <div className={styles.wrapper}>
          <div className={styles.vision_side} data-aos="fade-right">
            ...
            <p>
              To become a trusted and leading business solutions partner
              recognized for innovation, integrity, quality service and customer
              satisfaction. We envision empowering businesses with reliable and
              future ready solutions while building long lasting relationships
              founded on trust, professionalism and mutual growth.
            </p>
          </div>
          <div className={styles.mission_side} data-aos="fade-left">
            <h2 className={FONTS.font2}>Our Mission</h2>
            <p>
              At Amigos Business Solutions, our mission is to deliver
              customized, reliable and cost effective business solutions that
              meet the unique needs of every client. We are committed to
              combining industry expertise, innovative strategies and
              exceptional customer service to help businesses achieve
        ...
        <br/>
        <br/>
             <h2 className={FONTS.font2}>We Strive To:</h2>
            <ul>
