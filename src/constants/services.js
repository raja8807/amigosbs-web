export const SERVICES_DATA = {
  ...
  "wedding-planner": {
    ...
    fullContent: [
      ...
      '<div style="margin-top: 30px; padding: 20px; background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; display: inline-block;"><span style="color: #cecece; font-weight: 500; display: block; margin-bottom: 5px;">Email Us</span><a href="mailto:tanya@amigosbs.com" style="color: #e9021e; font-size: 20px; font-weight: 700; text-decoration: none; transition: color 0.3s ease;">sales@amigosbs.com</a></div>',
    ],
    features: [
